    ...
    while(operacion!=0){
       switch (operacion){
          ...
          case 2:{
               ...
               break;
          case 3:{
                printf("CARGA NOMBRES ESTUDIANTES DE MIRAMAR\n");
                 G=carga(vec3);
                  printf("CARGA NOMBRE ESTUDIANTES DE MAR DEL PLATA\n");
                 M=carga(vec4);
                 //printf("\t\tCargaste %d elementos",L);
                 }
               break;
          case 4:{
                 printf("MUESTRA NOMBRES DE ESTUDIANTES DE MIRAMAR\n");
                muestra(vec3,G);//miramar
                  printf("MUESTRA NOMBRES DE ESTUDIANTES DE MAR DEL PLATA\n");
                 muestra(vec4,M);//mdp
               break;
                 }
          case 5:{
                 printf("CARGA NOTAS DE ESTUDIANTES DE MIRAMAR\n");
                 L=carga(vec1);
                 printf("CARGA NOTAS DE ESTUDIANTES DE MAR DEL PLATA\n");
                 ll=carga(vec2);
                 break;
                 }
         case 6: {
                 printf("MUESTRA LAS NOTAS DE LOS ESTUDIANTES DE MIRAMAR\n");
                 muestra(vec1,L);
                 printf("MUESTRA LAS NOTAS DE ESTUDIANTES DE MAR DEL PLATA\n");
                 muestra(vec2,ll);
                 break;
                 }
       operacion=menu();
