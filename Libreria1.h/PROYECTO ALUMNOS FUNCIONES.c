...
int main(){
      ...
      char vecAlum.MI[20], vecAlum.Mar[20], J, G;
    int vec1[20],vec2[20];
    ...
    while(operacion!=0){
       switch (operacion){
          ...
          case 2:{
               ...
               break;
          case 3:{
                printf("CARGA LOS NOMBRES DE ESTUDIANTES DE MIRAMAR\n");
                J=carga vecAlum.MI[20]
                printf("CARGA NOTAS ESTUDIANTES DE MIRAMAR\n");
                 L=carga(vec1);
                 printf("CARGA LOS NOMBES DE LOS ESTUDIANTES DE MAR DEL PLATA\n");
                 G=cargavecAlum.Mar[20];
